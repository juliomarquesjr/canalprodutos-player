var playerElement = document.getElementById("tvProdutoPlayer");
...
var player = new Clappr.Player({
  source: "https://59f1cbe63db89.streamlock.net:1443/tvproduto/_definst_/tvproduto/playlist.m3u8",
  poster: "https://i.ibb.co/3BR0rpJ/fundotvcanalprodutos.jpg",
  plugins: [ChromecastPlugin],
  parentId: ".tvProdutoPlayer",
  autoPlay: true,
  mute: true,
  width: "100%",
  height: "100%",
  ...
  customData: {
    licenseURL: "http://tvproduto.com.br",
  },
  chromecast: {
    appId: "9DFB77C0",
